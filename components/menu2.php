            ...
            <div class="conteiner">
                ...
                <div class="food-cards__container">
                    <?php
                        ...
                        foreach( $posts as $post ){ setup_postdata($post);
                            ?>
                            <div class="food-cards__container__slide <?php the_field('progress-block'); ?>">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="days-slider">
                                        <div class="days-slider__slide days-slider__slide-first ">
                                            <span class="desctop">Понеділок</span>
                                            <span class="mob">ПН</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">Вівторок</span>
                                            <span class="mob">ВТ</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">Середа</span>
                                            <span class="mob">СР</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">Четвер</span>
                                            <span class="mob">ЧТ</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">П'ятниця</span>
                                            <span class="mob">ПТ</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">Субота</span>
                                            <span class="mob">СБ</span>
                                        </div>
                                        <div class="days-slider__slide">
                                            <span class="desctop">Неділля</span>
                                            <span class="mob">НД</span>
                                        </div>
                                    </div>
                                    <!--days-slider (days)-->
                                ...
                                <?php echo do_shortcode('[add_to_cart id="'.get_the_ID().'" style="border:none" show_price="false" class="add-button-style add-button-style-mob button0" quantity="1"]'); ?>
